...
class ConfigurationTest extends TestCase
{
    ...
    public function testDefaultValues(): void
    {
        ...
        $this->assertEquals('node', $result['node_path']);
        $this->assertEquals('%kernel.cache_dir%/morphql', $result['cache_dir']);
        $this->assertEquals('http://localhost:3000', $result['server_url']);
    ...
    public function testTimeoutMinimumValue(): void
    {
        $this->expectException(\Exception::class);
        $this->process(['timeout' => 0]);
    }
